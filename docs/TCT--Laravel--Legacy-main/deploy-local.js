...
const MIGRATE_SQLITE_TO_MYSQL_ON_DEPLOY = process.env.MIGRATE_SQLITE_TO_MYSQL_ON_DEPLOY === '1';
...
async function deploy() {
    ...
    try {
        const remoteCommand = MIGRATE_SQLITE_TO_MYSQL_ON_DEPLOY
            ? 'export MIGRATE_SQLITE_TO_MYSQL_ON_DEPLOY=1; bash ~/deploy/apps/thechoosentalks/deploy.sh'
