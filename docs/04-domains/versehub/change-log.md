...
- _State_ dinamika refleksi `reflection_question` dan `has_reflected` sengaja dibiarkan keras (*hard-coded*) di sisi antarmuka dan belum ditangkap dari pembongkaran data bawaan endpoint `loadChapter()`.
