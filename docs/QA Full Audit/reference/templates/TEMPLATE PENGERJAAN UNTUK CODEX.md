...
Mulai sekarang update engineering handoff menggunakan format resmi di:
- E:\thechoosentalksnext\docs\QA Full Audit\09-codex-handoff.md

Gunakan status dan section yang sudah ditetapkan. Saat fix selesai, isi:
- suspected root cause
...
Jangan memakai format bebas di luar template.
