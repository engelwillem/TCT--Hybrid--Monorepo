  ...
  return (
    ...
    >
      <div className="rounded-[28px] sm:rounded-[36px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(246,250,255,0.94))] px-4 sm:px-6 py-6 sm:py-8 shadow-[0_32px_110px_-60px_rgba(14,116,144,0.35)] backdrop-blur-xl">
        <p className="text-[11px] font-black uppercase tracking-[0.28em] text-[#0284c7]">Verse for you today</p>
        ...
        <div className="mt-4 flex items-start gap-2 text-[13px] leading-6 text-foreground/45">
          ...
          <p>
            Bookmark will save this reflection to your <span className="font-semibold text-foreground/68">personal Bookmarks</span> tab in{" "}
            <Link
              href="/community"
        ...
        <div className="mt-6 flex flex-wrap items-center gap-2">
          ...
          />
          <SurfaceBridgeAction target="renungan" label="Finish for today" href="/renungan" />
        </div>
      </div>
    </motion.section>
  );
