...
export default function TodayPage() {
  ...
  useEffect(() => {
    // Handling date on client side to avoid hydration mismatch
  ...
  const quickActions = [
    ...
    { label: "Read", icon: BookOpen, href: "/versehub/id", color: "bg-green-500/10 text-green-600", desc: "Baca firman" },
