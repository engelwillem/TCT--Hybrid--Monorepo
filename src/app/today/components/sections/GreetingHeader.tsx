            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/40 bg-white/70 px-6 py-5 shadow-sm backdrop-blur-xl dark:border-white/8 dark:bg-slate-900/60">
                ...
                <div className="flex items-end justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button className="flex h-11 w-11 items-center justify-center rounded-full bg-white/70 text-slate-500 shadow-sm ring-1 ring-black/5 transition-colors hover:text-cyan-500 dark:bg-white/8 dark:text-slate-400 dark:ring-white/10">
