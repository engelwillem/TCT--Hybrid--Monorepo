...
/** Strip common markdown bold prefixes like **Kutipan Rohani:** from AI-generated content */
...
export default function QuoteCard({
    ...
    return (
        <Card className={cn('rounded-[40px] bg-slate-50/50 dark:bg-slate-900/40 shadow-premium border border-white/40 dark:border-white/5 overflow-hidden transition-all duration-500 hover:shadow-2xl', className)}>
            <CardContent className={cn('relative space-y-8 flex flex-col items-center text-center', compact ? 'p-10' : 'p-12 md:p-16')}>
                {/* Decorative Quote Mark Background - Large and Faint */}
                <div className="absolute left-6 top-8 text-emerald-400/5 dark:text-emerald-400/10 select-none -z-0">
