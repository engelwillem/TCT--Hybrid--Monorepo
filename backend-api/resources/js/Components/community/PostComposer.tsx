                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-5 px-6 pt-8 pb-3">
                        <div className="relative group">
                            ...
                            <div className="relative h-14 w-14 shrink-0 rounded-full bg-surface-dark flex items-center justify-center overflow-hidden shadow-inner border border-white/30">
