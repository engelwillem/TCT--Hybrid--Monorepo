        ...
        <div className="space-y-4">
            <div className="space-y-3">
                ...
                <a href={verseHref} className="mt-1 block max-w-full" aria-label={`Buka ayat ${verse.reference}`}>
                    <h2 className="tct-h2 hover:underline">{verse.reference}</h2>
                </a>
            </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                            <button
                                ...
                                className="tct-pressable inline-flex items-center justify-center rounded-2xl bg-surface-dark px-4 py-2.5 font-semibold text-brand"
                            >
