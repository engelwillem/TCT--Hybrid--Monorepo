/**
 * MentorPanel.tsx — Scripture Guide Study Companion
 *
 * A standalone, self-contained overlay panel for per-verse guided study.
 * Extracted from Reader.tsx to keep concerns separated.
 *
 * Features:
 *  - Tab 1: Reflect   — reflection questions + theme connections
 *  - Tab 2: Context   — historical context + denominational overview
 *  - Tab 3: Ask       — free-text biblical Q&A (authenticated users only)
 *
 * TRANSPARENCY RULE: The "Scripture Guide / Bukan Manusia" label MUST
 * always be visible. Never conditionally hide it.
 */
...
export default function MentorPanel({
    ...
    function ensureInsights() {
        ...
        fetch(`/versehub/${encodeURIComponent(lang)}/${encodeURIComponent(verseRef)}/mentor`, {
    ...
    function handleAsk(e: React.FormEvent) {
        ...
        fetch(`/versehub/${encodeURIComponent(lang)}/${encodeURIComponent(verseRef)}/mentor/ask`, {
            method: 'POST',
            headers: {
